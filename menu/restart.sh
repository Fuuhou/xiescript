...
echo -e " [\e[36m11\e[0m] Restart NOOBZ"
echo -e ""
...
case $Restart in
                ...
                echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
                echo -e ""
                echo -e "[ \033[32mInfo\033[0m ] Restarting All Service (via systemctl)"
                sleep 1
                ...
                echo -e "[ \033[32mInfo\033[0m ] Restart Begin"
                sleep 1
                echo -e "[ \033[32mok\033[0m ] Restarting NOOBZ Service (via systemctl) "
                sleep 0.5
                systemctl restart noobzvpns.service
                sleep 0.5
                echo -e "[ \033[32mInfo\033[0m ] NOOBZ Service Restarted"
                echo ""
                echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
                echo ""
                read -n 1 -s -r -p "Press any key to back on system menu"
