...
if [[ ! -z "${PID}" ]]; then
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-ssh.log
echo -e "━━━━⟨ SSH_WS/SSL ⟩━━━━" | tee -a /etc/log-create-ssh.log
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-ssh.log
echo -e "Username : $Login" | tee -a /etc/log-create-ssh.log
echo -e "Password : $Pass" | tee -a /etc/log-create-ssh.log
echo -e "Hostname : $domen" | tee -a /etc/log-create-ssh.log
echo -e "Limit IP : 2" | tee -a /etc/log-create-vless.log
echo -e "$domen:$portsshws@$Login:$Pass" | tee -a /etc/log-create-ssh.log
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-ssh.log
echo -e "OpenSSH : $opensh" | tee -a /etc/log-create-ssh.log
echo -e "Dropbear : $db" | tee -a /etc/log-create-ssh.log
echo -e "Port WS : $portsshws" | tee -a /etc/log-create-ssh.log
echo -e "Port SSL WS : $wsssl" | tee -a /etc/log-create-ssh.log
...
echo -e "Port Squid : $sqd" | tee -a /etc/log-create-ssh.log
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-ssh.log
...
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-ssh.log
echo -e "━━━━⟨ SSH/WS ⟩━━━━" | tee -a /etc/log-create-ssh.log
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-ssh.log
echo -e "Username : $Login" | tee -a /etc/log-create-ssh.log
echo -e "Password : $Pass" | tee -a /etc/log-create-ssh.log
echo -e "Hostname : $domen" | tee -a /etc/log-create-ssh.log
