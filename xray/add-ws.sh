...
echo -e "━━━━⟨ XRAY/VMESS ⟩━━━━" | tee -a /etc/log-create-vmess.log
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-vmess.log
...
echo -e "Port N-TLS : ${none}" | tee -a /etc/log-create-vmess.log
...
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-vmess.log
echo -e "LINK N-TLS : ${vmesslink2}" | tee -a /etc/log-create-vmess.log
echo -e "━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-vmess.log
